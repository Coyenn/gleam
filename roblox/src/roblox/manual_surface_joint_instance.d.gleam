...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type ManualSurfaceJointInstance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ManualSurfaceJointInstance, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ManualSurfaceJointInstance, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ManualSurfaceJointInstance, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ManualSurfaceJointInstance, property: String) -> RBXScriptSignal

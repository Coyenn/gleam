...
import roblox/types.{type Actor, type Instance, type ReplicatedStorage, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ReplicatedStorage, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ReplicatedStorage, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ReplicatedStorage, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ReplicatedStorage, property: String) -> RBXScriptSignal

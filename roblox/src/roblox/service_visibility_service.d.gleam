...
import roblox/types.{type Actor, type BinaryString, type Instance, type SecurityCapabilities, type ServiceVisibilityService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ServiceVisibilityService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ServiceVisibilityService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ServiceVisibilityService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ServiceVisibilityService, property: String) -> RBXScriptSignal

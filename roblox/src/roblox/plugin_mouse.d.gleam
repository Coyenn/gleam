...
import roblox/types.{type Actor, type BasePart, type CFrame, type Content, type ContentId, type Instance, type NormalId, type PluginMouse, type Ray, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PluginMouse, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PluginMouse, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PluginMouse, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PluginMouse, property: String) -> RBXScriptSignal

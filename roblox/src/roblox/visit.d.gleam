...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UniqueId, type Visit}
...
pub fn get_attribute_changed_signal(instance: Visit, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Visit, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Visit, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Visit, property: String) -> RBXScriptSignal

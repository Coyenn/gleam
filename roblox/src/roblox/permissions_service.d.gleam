...
import roblox/types.{type Actor, type Instance, type PermissionsService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PermissionsService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PermissionsService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PermissionsService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PermissionsService, property: String) -> RBXScriptSignal

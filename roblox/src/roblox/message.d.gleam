...
import roblox/types.{type Actor, type Instance, type Message, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Message, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Message, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Message, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Message, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type FloatCurve, type Instance, type SecurityCapabilities, type UniqueId, type Vector3Curve}
...
pub fn get_attribute_changed_signal(instance: Vector3Curve, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Vector3Curve, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Vector3Curve, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Vector3Curve, property: String) -> RBXScriptSignal

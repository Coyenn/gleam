...
import roblox/types.{type Actor, type FacialAnimationStreamingServiceV2, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: FacialAnimationStreamingServiceV2, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: FacialAnimationStreamingServiceV2, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: FacialAnimationStreamingServiceV2, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: FacialAnimationStreamingServiceV2, property: String) -> RBXScriptSignal

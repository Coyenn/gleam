...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StyleRule, type UniqueId, type int?}
...
pub fn insert_style_rule(instance: StyleRule, rule: StyleRule, priority: int?) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleRule, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StyleRule, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StyleRule, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StyleRule, property: String) -> RBXScriptSignal

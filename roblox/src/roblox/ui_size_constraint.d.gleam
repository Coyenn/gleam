...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UISizeConstraint, type UniqueId, type Vector2}
...
pub fn get_attribute_changed_signal(instance: UISizeConstraint, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: UISizeConstraint, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: UISizeConstraint, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: UISizeConstraint, property: String) -> RBXScriptSignal

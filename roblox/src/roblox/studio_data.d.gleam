...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StudioData, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StudioData, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StudioData, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StudioData, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StudioData, property: String) -> RBXScriptSignal

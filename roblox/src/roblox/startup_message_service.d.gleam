...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StartupMessageService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StartupMessageService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StartupMessageService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StartupMessageService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StartupMessageService, property: String) -> RBXScriptSignal

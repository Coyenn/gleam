...
import roblox/types.{type Actor, type ForceField, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ForceField, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ForceField, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ForceField, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ForceField, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Attachment, type ColorSequence, type ContentId, type Instance, type NumberSequence, type SecurityCapabilities, type TextureMode, type Trail, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Trail, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Trail, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Trail, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Trail, property: String) -> RBXScriptSignal

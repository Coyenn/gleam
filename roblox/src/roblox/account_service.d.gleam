...
import roblox/types.{type AccountService, type Actor, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AccountService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AccountService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AccountService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AccountService, property: String) -> RBXScriptSignal

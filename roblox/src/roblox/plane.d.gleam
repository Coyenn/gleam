...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Instance, type Plane, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Plane, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Plane, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Plane, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Plane, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type ReflectionMetadataClass, type SecurityCapabilities, type ServiceVisibility, type UniqueId}
...
pub fn set_ui_maximum(instance: ReflectionMetadataClass, value: Float) -> ReflectionMetadataClass

@luau.property("UIMinimum")
pub fn get_ui_minimum(instance: ReflectionMetadataClass) -> Float

@luau.set_property("UIMinimum")
pub fn set_ui_minimum(instance: ReflectionMetadataClass, value: Float) -> ReflectionMetadataClass

@luau.property("UINumTicks")
pub fn get_ui_num_ticks(instance: ReflectionMetadataClass) -> Float

@luau.set_property("UINumTicks")
pub fn set_ui_num_ticks(instance: ReflectionMetadataClass, value: Float) -> ReflectionMetadataClass
...
pub fn get_attribute_changed_signal(instance: ReflectionMetadataClass, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ReflectionMetadataClass, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ReflectionMetadataClass, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ReflectionMetadataClass, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type AlphaMode, type Color3, type Content, type ContentId, type Instance, type Material, type MaterialPattern, type MaterialVariant, type PhysicalProperties, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: MaterialVariant, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: MaterialVariant, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: MaterialVariant, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: MaterialVariant, property: String) -> RBXScriptSignal

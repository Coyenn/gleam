...
import roblox/types.{type Actor, type AudioEqualizer, type Instance, type NumberRange, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AudioEqualizer, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AudioEqualizer, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AudioEqualizer, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AudioEqualizer, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type PluginDragEvent, type SecurityCapabilities, type UniqueId, type Vector2}
...
pub fn get_attribute_changed_signal(instance: PluginDragEvent, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PluginDragEvent, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PluginDragEvent, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PluginDragEvent, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type FaceAnimatorService, type Instance, type SecurityCapabilities, type TrackerFaceTrackingStatus, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: FaceAnimatorService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: FaceAnimatorService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: FaceAnimatorService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: FaceAnimatorService, property: String) -> RBXScriptSignal

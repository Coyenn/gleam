...
import roblox/types.{type Actor, type FlagStandService, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: FlagStandService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: FlagStandService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: FlagStandService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: FlagStandService, property: String) -> RBXScriptSignal

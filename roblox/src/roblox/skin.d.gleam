...
import roblox/types.{type Actor, type BrickColor, type Instance, type SecurityCapabilities, type Skin, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Skin, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Skin, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Skin, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Skin, property: String) -> RBXScriptSignal

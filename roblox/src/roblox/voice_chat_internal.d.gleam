...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UniqueId, type VoiceChatInternal}

@luau.method("IsVoiceEnabledForUserIdAsync")
pub fn is_voice_enabled_for_user_id_async(instance: VoiceChatInternal, user_id: Int) -> Bool
...
pub fn get_attribute_changed_signal(instance: VoiceChatInternal, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: VoiceChatInternal, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: VoiceChatInternal, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: VoiceChatInternal, property: String) -> RBXScriptSignal

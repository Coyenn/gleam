...
import roblox/types.{type Actor, type EchoSoundEffect, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: EchoSoundEffect, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: EchoSoundEffect, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: EchoSoundEffect, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: EchoSoundEffect, property: String) -> RBXScriptSignal

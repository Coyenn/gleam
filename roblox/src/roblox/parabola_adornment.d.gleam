...
import roblox/types.{type Actor, type Color3, type Instance, type PVInstance, type ParabolaAdornment, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ParabolaAdornment, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ParabolaAdornment, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ParabolaAdornment, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ParabolaAdornment, property: String) -> RBXScriptSignal

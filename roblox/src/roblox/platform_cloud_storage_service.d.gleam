...
import roblox/types.{type Actor, type Instance, type PlatformCloudStorageService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PlatformCloudStorageService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PlatformCloudStorageService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PlatformCloudStorageService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PlatformCloudStorageService, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UGCAvatarService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: UGCAvatarService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: UGCAvatarService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: UGCAvatarService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: UGCAvatarService, property: String) -> RBXScriptSignal

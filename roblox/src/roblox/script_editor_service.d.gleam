...
import roblox/types.{type Actor, type Instance, type ScriptEditorService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ScriptEditorService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ScriptEditorService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ScriptEditorService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ScriptEditorService, property: String) -> RBXScriptSignal

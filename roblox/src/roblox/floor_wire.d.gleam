...
import roblox/types.{type Actor, type BasePart, type Color3, type ContentId, type FloorWire, type Instance, type SecurityCapabilities, type UniqueId, type Vector2}
...
pub fn get_attribute_changed_signal(instance: FloorWire, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: FloorWire, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: FloorWire, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: FloorWire, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UniqueId, type WrapDeformMeshProvider}
...
pub fn get_attribute_changed_signal(instance: WrapDeformMeshProvider, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: WrapDeformMeshProvider, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: WrapDeformMeshProvider, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: WrapDeformMeshProvider, property: String) -> RBXScriptSignal

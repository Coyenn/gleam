...
import roblox/types.{type BasePart, type BrickColor, type CFrame, type CollisionFidelity, type Color3, type Faces, type Instance, type Material, type NormalId, type Object, type PVInstance, type PhysicalProperties, type Player, type RenderFidelity, type SurfaceType, type Vector3}

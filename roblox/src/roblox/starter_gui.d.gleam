...
import roblox/types.{type Actor, type CoreGuiType, type Instance, type ScreenOrientation, type SecurityCapabilities, type StarterGui, type StyleSheet, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StarterGui, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StarterGui, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StarterGui, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StarterGui, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type ActuatorRelativeTo, type Attachment, type BrickColor, type Instance, type SecurityCapabilities, type Torque, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: Torque, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Torque, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Torque, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Torque, property: String) -> RBXScriptSignal

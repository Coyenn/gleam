...
import roblox/types.{type Actor, type Color3, type Humanoid, type Instance, type SecurityCapabilities, type SelectionLasso, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: SelectionLasso, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: SelectionLasso, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: SelectionLasso, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: SelectionLasso, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type NetworkReplicator, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: NetworkReplicator, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: NetworkReplicator, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: NetworkReplicator, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: NetworkReplicator, property: String) -> RBXScriptSignal

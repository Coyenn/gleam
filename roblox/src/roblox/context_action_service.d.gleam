...
import roblox/types.{type Actor, type ContextActionService, type Instance, type KeyCode, type SecurityCapabilities, type UDim2, type UniqueId, type UserInputType}
...
pub fn get_attribute_changed_signal(instance: ContextActionService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ContextActionService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ContextActionService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ContextActionService, property: String) -> RBXScriptSignal

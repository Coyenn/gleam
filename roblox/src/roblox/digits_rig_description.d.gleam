...
import roblox/types.{type Actor, type CFrame, type DigitsRigDescription, type DigitsRigDescriptionSide, type Instance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: DigitsRigDescription, value: Instance) -> DigitsRigDescription
...
@luau.method("Destroy")
pub fn destroy(instance: DigitsRigDescription) -> Nil
...
pub fn get_attribute_changed_signal(instance: DigitsRigDescription, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: DigitsRigDescription, property: String) -> RBXScriptSignal

@luau.method("GetTags")
pub fn get_tags(instance: DigitsRigDescription) -> List(Dynamic)
...
pub fn wait_for_child(instance: DigitsRigDescription, child_name: String, time_out: Float) -> Instance

@luau.event("AncestryChanged")
pub fn ancestry_changed(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("AttributeChanged")
pub fn attribute_changed(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("ChildAdded")
pub fn child_added(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("ChildRemoved")
pub fn child_removed(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("DescendantAdded")
pub fn descendant_added(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("DescendantRemoving")
pub fn descendant_removing(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("Destroying")
pub fn destroying(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.event("StyledPropertiesChanged")
pub fn styled_properties_changed(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

@luau.property("ClassName")
pub fn get_class_name(instance: DigitsRigDescription) -> String

@luau.method("GetPropertyChangedSignal")
pub fn get_property_changed_signal(instance: DigitsRigDescription, property: String) -> RBXScriptSignal

@luau.method("IsA")
pub fn is_a(instance: DigitsRigDescription, class_name: String) -> Bool

@luau.event("Changed")
pub fn changed(instance: DigitsRigDescription) -> RBXScriptSignal(Dynamic)

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type TemporaryCageMeshProvider, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: TemporaryCageMeshProvider, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: TemporaryCageMeshProvider, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: TemporaryCageMeshProvider, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: TemporaryCageMeshProvider, property: String) -> RBXScriptSignal

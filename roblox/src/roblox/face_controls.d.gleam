...
import roblox/types.{type Actor, type FaceControls, type Instance, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: FaceControls, attribute: String) -> RBXScriptSignal(Dynamic)
...
pub fn get_styled_property_changed_signal(instance: FaceControls, property: String) -> RBXScriptSignal(Dynamic)
...
pub fn wait_for_child(instance: FaceControls, child_name: String, time_out: OptionDouble) -> Instance
...
pub fn get_property_changed_signal(instance: FaceControls, property: String) -> RBXScriptSignal(Dynamic)

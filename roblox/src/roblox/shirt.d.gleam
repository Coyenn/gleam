...
import roblox/types.{type Actor, type Color3, type ContentId, type Instance, type SecurityCapabilities, type Shirt, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Shirt, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Shirt, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Shirt, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Shirt, property: String) -> RBXScriptSignal

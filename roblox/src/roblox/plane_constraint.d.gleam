...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Instance, type PlaneConstraint, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PlaneConstraint, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PlaneConstraint, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PlaneConstraint, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PlaneConstraint, property: String) -> RBXScriptSignal

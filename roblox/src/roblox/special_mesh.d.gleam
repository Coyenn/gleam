...
import roblox/types.{type Actor, type ContentId, type Instance, type MeshType, type SecurityCapabilities, type SpecialMesh, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: SpecialMesh, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: SpecialMesh, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: SpecialMesh, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: SpecialMesh, property: String) -> RBXScriptSignal

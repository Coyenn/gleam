...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Instance, type RodConstraint, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RodConstraint, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RodConstraint, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RodConstraint, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RodConstraint, property: String) -> RBXScriptSignal

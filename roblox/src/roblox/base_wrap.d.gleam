...
import roblox/types.{type Actor, type BaseWrap, type CFrame, type Content, type ContentId, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: BaseWrap, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: BaseWrap, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: BaseWrap, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: BaseWrap, property: String) -> RBXScriptSignal

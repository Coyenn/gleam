...
import roblox/types.{type Actor, type AvatarClothingRules, type AvatarSettingsClothingMode, type AvatarSettingsCustomClothingMode, type Instance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn get_custom_classic_pants_accessory_id(instance: AvatarClothingRules) -> Int
...
pub fn get_custom_classic_shirts_accessory_id(instance: AvatarClothingRules) -> Int
...
pub fn get_custom_classic_t_shirts_accessory_id(instance: AvatarClothingRules) -> Int
...
pub fn get_attribute_changed_signal(instance: AvatarClothingRules, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AvatarClothingRules, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AvatarClothingRules, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AvatarClothingRules, property: String) -> RBXScriptSignal

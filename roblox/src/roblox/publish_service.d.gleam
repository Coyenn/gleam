...
import roblox/types.{type Actor, type Instance, type PublishService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PublishService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PublishService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PublishService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PublishService, property: String) -> RBXScriptSignal

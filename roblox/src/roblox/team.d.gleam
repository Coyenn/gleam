...
import roblox/types.{type Actor, type BrickColor, type Instance, type SecurityCapabilities, type Team, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Team, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Team, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Team, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Team, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type AssetPatchSettings, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AssetPatchSettings, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AssetPatchSettings, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AssetPatchSettings, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AssetPatchSettings, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type SessionService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: SessionService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: SessionService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: SessionService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: SessionService, property: String) -> RBXScriptSignal

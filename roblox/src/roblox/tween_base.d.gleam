...
import roblox/types.{type Actor, type Instance, type PlaybackState, type SecurityCapabilities, type TweenBase, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: TweenBase, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: TweenBase, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: TweenBase, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: TweenBase, property: String) -> RBXScriptSignal

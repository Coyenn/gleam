...
import roblox/types.{type Actor, type EasingDirection, type EasingStyle, type Instance, type SecurityCapabilities, type Tween, type TweenInfo, type TweenService, type UniqueId, type float?}

@luau.method("Create")
pub fn create(instance: TweenService, instance: Instance, tween_info: TweenInfo, property_table: Dynamic) -> Tween
...
pub fn smooth_damp(instance: TweenService, current: Dynamic, target: Dynamic, velocity: Dynamic, smooth_time: Float, max_speed: float?, dt: float?) -> Dynamic
...
pub fn get_attribute_changed_signal(instance: TweenService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: TweenService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: TweenService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: TweenService, property: String) -> RBXScriptSignal

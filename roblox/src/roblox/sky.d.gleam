...
import roblox/types.{type Actor, type Content, type ContentId, type Instance, type SecurityCapabilities, type Sky, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: Sky, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Sky, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Sky, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Sky, property: String) -> RBXScriptSignal

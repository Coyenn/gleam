...
import roblox/types.{type Actor, type Content, type Instance, type SecurityCapabilities, type UniqueId, type Vector2, type WrapTextureTransfer}
...
pub fn get_attribute_changed_signal(instance: WrapTextureTransfer, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: WrapTextureTransfer, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: WrapTextureTransfer, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: WrapTextureTransfer, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type RemoteDebuggerServer, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RemoteDebuggerServer, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RemoteDebuggerServer, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RemoteDebuggerServer, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RemoteDebuggerServer, property: String) -> RBXScriptSignal

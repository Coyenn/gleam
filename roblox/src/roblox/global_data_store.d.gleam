...
import roblox/types.{type Actor, type DataStoreGetOptions, type DataStoreIncrementOptions, type DataStoreSetOptions, type GlobalDataStore, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: GlobalDataStore, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: GlobalDataStore, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: GlobalDataStore, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: GlobalDataStore, property: String) -> RBXScriptSignal

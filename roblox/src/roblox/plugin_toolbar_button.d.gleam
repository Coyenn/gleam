...
import roblox/types.{type Actor, type ContentId, type Instance, type PluginToolbarButton, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PluginToolbarButton, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PluginToolbarButton, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PluginToolbarButton, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PluginToolbarButton, property: String) -> RBXScriptSignal

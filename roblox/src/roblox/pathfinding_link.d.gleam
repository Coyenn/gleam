...
import roblox/types.{type Actor, type Attachment, type Instance, type PathfindingLink, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PathfindingLink, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PathfindingLink, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PathfindingLink, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PathfindingLink, property: String) -> RBXScriptSignal

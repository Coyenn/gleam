...
import roblox/types.{type Actor, type Clothing, type Color3, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Clothing, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Clothing, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Clothing, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Clothing, property: String) -> RBXScriptSignal

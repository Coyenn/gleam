...
import roblox/types.{type Actor, type Clouds, type Color3, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Clouds, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Clouds, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Clouds, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Clouds, property: String) -> RBXScriptSignal

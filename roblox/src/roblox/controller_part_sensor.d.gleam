...
import roblox/types.{type Actor, type BasePart, type CFrame, type ControllerPartSensor, type Instance, type Material, type SecurityCapabilities, type SensorMode, type SensorUpdateType, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: ControllerPartSensor, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ControllerPartSensor, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ControllerPartSensor, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ControllerPartSensor, property: String) -> RBXScriptSignal

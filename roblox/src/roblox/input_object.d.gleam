...
import roblox/types.{type Actor, type InputObject, type Instance, type KeyCode, type ModifierKey, type SecurityCapabilities, type UniqueId, type UserInputState, type UserInputType, type Vector3}
...
pub fn get_attribute_changed_signal(instance: InputObject, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: InputObject, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: InputObject, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: InputObject, property: String) -> RBXScriptSignal

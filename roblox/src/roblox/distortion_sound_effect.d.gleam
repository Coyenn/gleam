...
import roblox/types.{type Actor, type DistortionSoundEffect, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: DistortionSoundEffect, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: DistortionSoundEffect, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: DistortionSoundEffect, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: DistortionSoundEffect, property: String) -> RBXScriptSignal

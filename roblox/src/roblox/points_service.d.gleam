...
import roblox/types.{type Actor, type Instance, type PointsService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PointsService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PointsService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PointsService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PointsService, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type RealtimeMedia, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RealtimeMedia, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RealtimeMedia, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RealtimeMedia, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RealtimeMedia, property: String) -> RBXScriptSignal

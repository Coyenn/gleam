...
pub fn get_attribute_changed_signal(instance: StarterPlayer, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StarterPlayer, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StarterPlayer, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StarterPlayer, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type BaseCoreGuiConfiguration, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: BaseCoreGuiConfiguration, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: BaseCoreGuiConfiguration, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: BaseCoreGuiConfiguration, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: BaseCoreGuiConfiguration, property: String) -> RBXScriptSignal

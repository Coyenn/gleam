...
import roblox/types.{type Actor, type CFrame, type Instance, type PVInstance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PVInstance, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PVInstance, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PVInstance, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PVInstance, property: String) -> RBXScriptSignal

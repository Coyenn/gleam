...
import roblox/types.{type Actor, type EqualizerSoundEffect, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: EqualizerSoundEffect, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: EqualizerSoundEffect, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: EqualizerSoundEffect, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: EqualizerSoundEffect, property: String) -> RBXScriptSignal

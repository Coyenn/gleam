...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StudioCaptureService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StudioCaptureService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StudioCaptureService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StudioCaptureService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StudioCaptureService, property: String) -> RBXScriptSignal

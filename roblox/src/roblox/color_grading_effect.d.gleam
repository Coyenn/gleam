...
import roblox/types.{type Actor, type ColorGradingEffect, type Instance, type SecurityCapabilities, type TonemapperPreset, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ColorGradingEffect, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ColorGradingEffect, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ColorGradingEffect, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ColorGradingEffect, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type Selection, type SelectionRenderMode, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Selection, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Selection, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Selection, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Selection, property: String) -> RBXScriptSignal

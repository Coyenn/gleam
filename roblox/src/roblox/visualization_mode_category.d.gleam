...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UniqueId, type VisualizationModeCategory}
...
pub fn get_attribute_changed_signal(instance: VisualizationModeCategory, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: VisualizationModeCategory, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: VisualizationModeCategory, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: VisualizationModeCategory, property: String) -> RBXScriptSignal

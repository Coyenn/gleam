...
import roblox/types.{type Actor, type AnimationConstraint, type Attachment, type BrickColor, type CFrame, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AnimationConstraint, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AnimationConstraint, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AnimationConstraint, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AnimationConstraint, property: String) -> RBXScriptSignal

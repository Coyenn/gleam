...
import roblox/types.{type Actor, type BasePart, type Color3, type Faces, type Handles, type HandlesStyle, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Handles, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Handles, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Handles, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Handles, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type AdornCullingMode, type AdornShading, type CFrame, type Color3, type ConeHandleAdornment, type Instance, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: ConeHandleAdornment, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ConeHandleAdornment, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ConeHandleAdornment, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ConeHandleAdornment, property: String) -> RBXScriptSignal

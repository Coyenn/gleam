...
import roblox/types.{type Actor, type AnimationNodeDefinition, type AnimationNodeType, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AnimationNodeDefinition, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AnimationNodeDefinition, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AnimationNodeDefinition, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AnimationNodeDefinition, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type Ray, type RayValue, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RayValue, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RayValue, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RayValue, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RayValue, property: String) -> RBXScriptSignal

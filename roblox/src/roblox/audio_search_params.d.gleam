...
import roblox/types.{type Actor, type AudioSearchParams, type AudioSubType, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AudioSearchParams, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AudioSearchParams, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AudioSearchParams, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AudioSearchParams, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type ServerScriptService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ServerScriptService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ServerScriptService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ServerScriptService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ServerScriptService, property: String) -> RBXScriptSignal

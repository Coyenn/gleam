...
import roblox/types.{type Actor, type CFrame, type HumanoidRigDescription, type Instance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: HumanoidRigDescription, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: HumanoidRigDescription, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: HumanoidRigDescription, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: HumanoidRigDescription, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type KeyInterpolationMode, type SecurityCapabilities, type UniqueId, type ValueCurve, type ValueCurveKey, type Variant?}
...
pub fn get_value_at_time(instance: ValueCurve, time: Float) -> Variant?
...
pub fn get_attribute_changed_signal(instance: ValueCurve, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ValueCurve, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ValueCurve, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ValueCurve, property: String) -> RBXScriptSignal

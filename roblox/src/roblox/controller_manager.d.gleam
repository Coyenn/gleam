...
import roblox/types.{type Actor, type BasePart, type ControllerBase, type ControllerManager, type ControllerSensor, type Instance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: ControllerManager, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ControllerManager, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ControllerManager, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ControllerManager, property: String) -> RBXScriptSignal

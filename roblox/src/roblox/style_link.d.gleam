...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StyleLink, type StyleSheet, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StyleLink, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StyleLink, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StyleLink, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StyleLink, property: String) -> RBXScriptSignal

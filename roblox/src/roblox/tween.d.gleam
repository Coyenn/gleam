...
import roblox/types.{type Actor, type Instance, type PlaybackState, type SecurityCapabilities, type Tween, type TweenInfo, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: Tween, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Tween, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Tween, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Tween, property: String) -> RBXScriptSignal

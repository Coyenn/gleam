...
import roblox/types.{type Actor, type Color3, type Instance, type SecurityCapabilities, type UDim, type UDim2, type UIShadow, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: UIShadow, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: UIShadow, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: UIShadow, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: UIShadow, property: String) -> RBXScriptSignal

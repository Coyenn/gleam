...
import roblox/types.{type Actor, type Instance, type LocalizationTable, type Rect, type SafeAreaCompatibility, type ScreenGui, type ScreenInsets, type SecurityCapabilities, type SelectionBehavior, type UniqueId, type Vector2, type ZIndexBehavior}
...
pub fn get_attribute_changed_signal(instance: ScreenGui, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ScreenGui, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ScreenGui, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ScreenGui, property: String) -> RBXScriptSignal

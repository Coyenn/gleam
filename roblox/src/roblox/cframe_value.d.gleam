...
import roblox/types.{type Actor, type CFrame, type CFrameValue, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: CFrameValue, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: CFrameValue, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: CFrameValue, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: CFrameValue, property: String) -> RBXScriptSignal

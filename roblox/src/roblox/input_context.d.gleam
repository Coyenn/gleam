...
import roblox/types.{type Actor, type InputContext, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: InputContext, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: InputContext, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: InputContext, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: InputContext, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type AudioChannelLayout, type AudioChannelSplitter, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AudioChannelSplitter, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AudioChannelSplitter, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AudioChannelSplitter, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AudioChannelSplitter, property: String) -> RBXScriptSignal

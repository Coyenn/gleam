...
import roblox/types.{type Actor, type Instance, type ProcessInstancePhysicsService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ProcessInstancePhysicsService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ProcessInstancePhysicsService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ProcessInstancePhysicsService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ProcessInstancePhysicsService, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Color3, type ContentId, type Instance, type SecurityCapabilities, type ShirtGraphic, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ShirtGraphic, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ShirtGraphic, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ShirtGraphic, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ShirtGraphic, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type TelemetryService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: TelemetryService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: TelemetryService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: TelemetryService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: TelemetryService, property: String) -> RBXScriptSignal

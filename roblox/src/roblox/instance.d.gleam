...
pub fn get_attribute_changed_signal(instance: Instance, attribute: String) -> RBXScriptSignal(Dynamic)
...
pub fn get_styled_property_changed_signal(instance: Instance, property: String) -> RBXScriptSignal(Dynamic)
...
pub fn wait_for_child(instance: Instance, child_name: String, time_out: OptionDouble) -> Instance

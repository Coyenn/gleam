...
import roblox/types.{type Actor, type Instance, type LocalScript, type ProtectedString, type RunContext, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: LocalScript, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: LocalScript, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: LocalScript, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: LocalScript, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Color3, type Instance, type NormalId, type SecurityCapabilities, type SpotLight, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: SpotLight, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: SpotLight, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: SpotLight, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: SpotLight, property: String) -> RBXScriptSignal

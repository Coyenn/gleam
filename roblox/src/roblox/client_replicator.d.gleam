...
import roblox/types.{type Actor, type ClientReplicator, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: ClientReplicator, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ClientReplicator, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ClientReplicator, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ClientReplicator, property: String) -> RBXScriptSignal

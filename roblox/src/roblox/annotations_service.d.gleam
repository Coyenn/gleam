...
import roblox/types.{type Actor, type Annotation, type AnnotationEditingMode, type AnnotationRequestStatus, type AnnotationsService, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AnnotationsService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: AnnotationsService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: AnnotationsService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: AnnotationsService, property: String) -> RBXScriptSignal

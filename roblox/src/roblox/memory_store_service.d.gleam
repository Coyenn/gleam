...
import roblox/types.{type Actor, type Instance, type MemoryStoreHashMap, type MemoryStoreQueue, type MemoryStoreService, type MemoryStoreSortedMap, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: MemoryStoreService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: MemoryStoreService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: MemoryStoreService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: MemoryStoreService, property: String) -> RBXScriptSignal

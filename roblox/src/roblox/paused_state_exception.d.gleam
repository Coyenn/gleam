...
import roblox/types.{type Actor, type DebuggerPauseReason, type Instance, type PausedStateException, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: PausedStateException, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: PausedStateException, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: PausedStateException, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: PausedStateException, property: String) -> RBXScriptSignal

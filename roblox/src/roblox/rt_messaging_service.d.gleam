...
import roblox/types.{type Actor, type Instance, type RtMessagingService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RtMessagingService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RtMessagingService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RtMessagingService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RtMessagingService, property: String) -> RBXScriptSignal

...
import roblox/types.{type Accoutrement, type Actor, type CFrame, type Instance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: Accoutrement, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Accoutrement, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Accoutrement, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Accoutrement, property: String) -> RBXScriptSignal

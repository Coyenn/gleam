...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StyleBase, type StyleRule, type UniqueId, type int?}

@luau.method("GetStyleRules")
pub fn get_style_rules(instance: StyleBase) -> List(Instance)

@luau.method("InsertStyleRule")
pub fn insert_style_rule(instance: StyleBase, rule: StyleRule, priority: int?) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleBase, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StyleBase, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StyleBase, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StyleBase, property: String) -> RBXScriptSignal

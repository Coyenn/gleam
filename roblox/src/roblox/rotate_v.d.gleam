...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type RotateV, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: RotateV, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: RotateV, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: RotateV, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: RotateV, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type Motor, type SecurityCapabilities, type UniqueId}
...
pub fn set_desired_angle(instance: Motor, value: Float) -> Nil
...
pub fn get_attribute_changed_signal(instance: Motor, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: Motor, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: Motor, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: Motor, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type UniqueId, type UnvalidatedAssetService}
...
pub fn get_attribute_changed_signal(instance: UnvalidatedAssetService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: UnvalidatedAssetService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: UnvalidatedAssetService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: UnvalidatedAssetService, property: String) -> RBXScriptSignal

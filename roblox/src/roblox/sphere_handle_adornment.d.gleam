...
import roblox/types.{type Actor, type AdornCullingMode, type AdornShading, type CFrame, type Color3, type Instance, type PVInstance, type SecurityCapabilities, type SphereHandleAdornment, type UniqueId, type Vector3}
...
pub fn get_attribute_changed_signal(instance: SphereHandleAdornment, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: SphereHandleAdornment, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: SphereHandleAdornment, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: SphereHandleAdornment, property: String) -> RBXScriptSignal

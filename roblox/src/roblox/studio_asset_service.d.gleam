...
import roblox/types.{type Actor, type Instance, type SecurityCapabilities, type StudioAssetService, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StudioAssetService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: StudioAssetService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: StudioAssetService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: StudioAssetService, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type ScriptContext, type SecurityCapabilities, type UniqueId}

@luau.property("ScriptsDisabled")
pub fn get_scripts_disabled(instance: ScriptContext) -> Bool

@luau.method("EnableCoverage")
pub fn enable_coverage(instance: ScriptContext, instance: Instance) -> Nil
...
pub fn get_attribute_changed_signal(instance: ScriptContext, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ScriptContext, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ScriptContext, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ScriptContext, property: String) -> RBXScriptSignal

...
import roblox/types.{type Actor, type Instance, type MatchmakingService, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: MatchmakingService, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: MatchmakingService, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: MatchmakingService, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: MatchmakingService, property: String) -> RBXScriptSignal

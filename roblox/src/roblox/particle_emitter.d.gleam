...
pub fn get_attribute_changed_signal(instance: ParticleEmitter, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: ParticleEmitter, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: ParticleEmitter, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: ParticleEmitter, property: String) -> RBXScriptSignal

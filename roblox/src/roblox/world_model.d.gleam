...
import roblox/types.{type Actor, type BasePart, type BulkMoveMode, type CFrame, type Instance, type ModelLevelOfDetail, type ModelStreamingMode, type OverlapParams, type Player, type RaycastParams, type RaycastResult?, type SecurityCapabilities, type UniqueId, type Vector3, type WorldModel}
...
pub fn blockcast(instance: WorldModel, cframe: CFrame, size: Vector3, direction: Vector3, params: RaycastParams) -> RaycastResult?
...
@luau.method("Raycast")
pub fn raycast(instance: WorldModel, origin: Vector3, direction: Vector3, raycast_params: RaycastParams) -> RaycastResult?

@luau.method("Shapecast")
pub fn shapecast(instance: WorldModel, part: BasePart, direction: Vector3, params: RaycastParams) -> RaycastResult?

@luau.method("Spherecast")
pub fn spherecast(instance: WorldModel, position: Vector3, radius: Float, direction: Vector3, params: RaycastParams) -> RaycastResult?
...
pub fn get_attribute_changed_signal(instance: WorldModel, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: WorldModel, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: WorldModel, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: WorldModel, property: String) -> RBXScriptSignal

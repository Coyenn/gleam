...
import roblox/types.{type Actor, type BasePlayerGui, type Instance, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: BasePlayerGui, attribute: String) -> RBXScriptSignal
...
pub fn get_styled_property_changed_signal(instance: BasePlayerGui, property: String) -> RBXScriptSignal
...
pub fn wait_for_child(instance: BasePlayerGui, child_name: String, time_out: Float) -> Instance
...
pub fn get_property_changed_signal(instance: BasePlayerGui, property: String) -> RBXScriptSignal
